// IconsFontAwesome6.h - icon codepoint #defines for the editor's icon font.
//
// Vendored VERBATIM from IconFontCppHeaders
// (https://github.com/juliettef/IconFontCppHeaders, commit
// 8a381189ecfe58e732466cc52e79ca887dd6a297), which generates it from the Font
// Awesome 6 metadata. Vendored (rather than pulled through vcpkg) because the
// project's pinned vcpkg baseline carries no iconfontcppheaders port; a single
// header of codepoint macros is an editor asset-level dependency. It pairs with
// tools/editor/media/fa-solid-900.ttf (Font Awesome 6 Free, Solid). The macro
// vocabulary (ICON_MIN_FA/ICON_MAX_FA + ICON_FA_*) is what the font-atlas merge
// and the asset browser's kind icons reference.
//
// IconFontCppHeaders is distributed under the zlib licence (see
// tools/editor/media/LICENSE-iconfontcppheaders.txt):
//
