...
#else
	#include "core_tinyxml/tinystr.h"
...
protected:
	...
	class ORKIGE_DLL StringToBuffer
	{
	  public:
...
*/
class ORKIGE_DLL TiXmlNode : public TiXmlBase
{
	friend class TiXmlDocument;
	friend class TiXmlElement;
...
*/
class ORKIGE_DLL TiXmlAttribute : public TiXmlBase
{
...
*/
class ORKIGE_DLL TiXmlAttributeSet
{
public:
	TiXmlAttributeSet();
	~TiXmlAttributeSet();
...
*/
class ORKIGE_DLL TiXmlElement : public TiXmlNode
{
public:
...
/**	An XML comment.
*/
class ORKIGE_DLL TiXmlComment : public TiXmlNode
{
public:
...
*/
class ORKIGE_DLL TiXmlText : public TiXmlNode
{
	friend class TiXmlElement;
public:
...
*/
class ORKIGE_DLL TiXmlDeclaration : public TiXmlNode
{
public:
...
*/
class ORKIGE_DLL TiXmlUnknown : public TiXmlNode
{
public:
...
*/
class ORKIGE_DLL TiXmlDocument : public TiXmlNode
{
public:
	...
	*/
	#ifdef ORKIGE_NDS
		bool LoadFile( FSFile* file, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	#else
