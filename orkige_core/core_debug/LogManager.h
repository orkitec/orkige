...
namespace Orkige
{
	...
	*  @{ */
	...
	public:
		...
		void write(const char * tag, int level,String const & message, Priority priorityLevel, char* fileName,int lineNumber);
		//! write a logmessage
		void write(String const & message, Priority priorityLevel, char* fileName,int lineNumber);
	...
	//---------------------------------------------------------------
	inline void LogManager::py_write(const char * tag,int level,String const & message, Priority priorityLevel, char* fileName,int lineNumber)
	{
