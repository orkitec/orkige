...
A second leg makes the staged shader media **unreadable** and asserts the render
...
- **Project export from a distributed editor** still shells out to Python, which
  a copied app has no reason to have.
