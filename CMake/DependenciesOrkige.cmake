...
if (ORKIGE_BROWSERPLUGIN)
	if(WIN32)
		find_package(Java)
		macro_log_feature(JAVA_FOUND "Java Jre" "Support for Java" TRUE "" "")
		find_package(7zip)
		macro_log_feature(7ZIP_FOUND "7zip" "Support for 7zip" TRUE "" "")
	endif()
endif()
#######################################################################
# Apple-specific
#######################################################################
if (APPLE AND NOT ORKIGE_BUILD_IPHONE)
    find_package(Carbon)
