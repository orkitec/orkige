...
IF (WIN32)
  ...
  ELSE (CYGWIN)
    ...
    ELSE(BORLAND)
      ...
      SET (DEFAULT_OPENGLES2_INCLUDE_DIR ${ORKIGE_SOURCE_DIR}/Dependencies/Win32/gles2/include)
      SET (DEFAULT_OPENGLES2_LIBRARY_PATH ${ORKIGE_SOURCE_DIR}/Dependencies/Win32/gles2/lib)
