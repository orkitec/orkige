...
#include "rapidxml.hpp"
    ...
    public:
        ...
        void parseDotScene(const Ogre::String &SceneName, const Ogre::String &groupName, Ogre::SceneManager *yourSceneMgr, Ogre::SceneNode *pAttachNode = NULL, const Ogre::String &sPrependNode = "", Ogre::String _namePrefix = "");
		...
		std::map<Ogre::String, Ogre::Plane> planes;
		bool enableCustomLod;
		bool useLodBoundingBoxAsDefault;
		Ogre::Real customLodDistance;
    ...
    protected:
		...
		void processUserData(rapidxml::xml_node<>* XMLNode, Ogre::SceneNode *pParent = 0);
		...
		void processSubEntity(rapidxml::xml_node<>* XMLNode, Ogre::Entity *pParent);
