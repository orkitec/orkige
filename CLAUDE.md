...
atlases generated by `Util/make_gui_atlas.py`; `engine_filesystem` wraps archives;
...
verified by the player_benchmark_vista ctest (next flavor — the long sequence trips the
classic RTSS backend, see `Docs/benchmark.md`);
