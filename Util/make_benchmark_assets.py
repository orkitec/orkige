...
- Vector animation `walker.oanim`: cooked by the engine's own `animcook` from a
...
def walker_lottie():
    ...
    shaped to cook cleanly through core_util/VectorAnimCook."""
...
def build_all(project_dir):
    ...
    vsd.run_animcook(walker_json, assets / "walker.oanim")
    ...
    for name in ("hamster", "dragon", "cat_loader", "frog_vr", "snail"):
        ...
        vsd.run_animcook(destination, corpus_dest / (name + ".oanim"))
