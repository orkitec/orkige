...
ORKIGE_MODULE(orkige_engine)
	...
	OWEAKHANDLE_BEGIN(Orkige::GuiWidget, "WidgetHandle", "widget handle", "widget")
		...
		OWEAKHANDLE_BASEMETHOD(setFontIndex)
		OWEAKHANDLE_BASEMETHOD(getFontIndex)
		...
		OWEAKHANDLE_LEAFMETHOD2(setWrap, Orkige::GuiLabel, Orkige::GuiTextbox)
		...
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiListView, getItemText)
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiListView, setVirtualized)
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiListView, isVirtualized)
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiListView, setItemHeight)
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiListView, getItemHeight)
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiListView, getMaterializedCount)
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiListView, getFirstMaterializedIndex)
		...
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiTextEntry, setMultiline)
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiTextEntry, isMultiline)
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiTextEntry, getLineCount)
		OWEAKHANDLE_LEAFMETHOD(Orkige::GuiTextEntry, getFirstVisibleLine)
	OWEAKHANDLE_END
