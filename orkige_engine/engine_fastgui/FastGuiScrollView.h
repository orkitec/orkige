/********************************************************************
	...
	filename: 	FastGuiScrollView.h
	author:		steffen.roemer
	notice:		This source file is part of orkige (orkitec Game engine)
				For the latest info, see http://www.orkitec.com/
	copyright:	(c) 2009-2026 orkitec
*********************************************************************/
#ifndef __FastGuiScrollView_h__11_7_2026__15_00_00__
#define __FastGuiScrollView_h__11_7_2026__15_00_00__
...
namespace Orkige
{
	...
	class ORKIGE_ENGINE_DLL FastGuiScrollView : public FastGuiWidget
	{
		OOBJECT(FastGuiScrollView, FastGuiWidget);
	public:
		...
		FastGuiScrollView(String const & id, Ogre::Vector2 const & position,
			Ogre::Vector2 const & size, String const & atlas, uint z);
		virtual ~FastGuiScrollView();
...
#endif //__FastGuiScrollView_h__11_7_2026__15_00_00__
