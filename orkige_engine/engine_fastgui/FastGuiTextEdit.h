/********************************************************************
	...
	filename: 	FastGuiTextEdit.h
	author:		steffen.roemer
	notice:		This source file is part of orkige (orkitec Game engine)
				For the latest info, see http://www.orkitec.com/
	copyright:	(c) 2009-2011 orkitec
*********************************************************************/
#ifndef __FastGuiTextEdit_h__11_7_2026__12_00_00__
#define __FastGuiTextEdit_h__11_7_2026__12_00_00__

#include "core_util/String.h"

namespace Orkige
{
	//! @brief the PURE single-line text-editing model behind FastGuiTextEntry:
...
#endif //__FastGuiTextEdit_h__11_7_2026__12_00_00__
