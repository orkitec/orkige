/********************************************************************
	...
	filename: 	FastGuiTextEntry.h
	author:		steffen.roemer
	notice:		This source file is part of orkige (orkitec Game engine)
				For the latest info, see http://www.orkitec.com/
	copyright:	(c) 2009-2011 orkitec
*********************************************************************/
#ifndef __FastGuiTextEntry_h__11_7_2026__12_00_00__
#define __FastGuiTextEntry_h__11_7_2026__12_00_00__
...
namespace Orkige
{
	...
	//! placeholder text. Renders on the atlas font through the fastgui
	//! DrawLayer2D facade, so it works on BOTH render flavors.
	//! @remarks Focus is coordinated by FastGuiManager (one field focused at a
	...
	//! pure editing model lives in FastGuiTextEdit.h (headless-tested).
	class ORKIGE_ENGINE_DLL FastGuiTextEntry : public FastGuiWidget
	{
		OOBJECT(FastGuiTextEntry, FastGuiWidget);
		//--- Types -------------------------------------------------
	public:
	protected:
	private:
	...
	protected:
		...
		//--- Methods -----------------------------------------------
	public:
		FastGuiTextEntry(String const & id, String const & spriteName,
		...
		//! press while focused (the polled idiom, like FastGuiButton::wasClicked)
		bool wasSubmitted();

		//! @brief flip the focused state WITHOUT touching the SDL text-input
		//! session - FastGuiManager::focusTextEntry owns the session and calls
...
#endif //__FastGuiTextEntry_h__11_7_2026__12_00_00__
