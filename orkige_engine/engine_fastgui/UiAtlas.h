...
//! @file UiAtlas.h
//! @brief the .ogui texture-atlas model of the fastgui system: sprites,
...
//! (Util/make_fastgui_atlas.py generates it, FastGuiAtlasTests verifies
...
namespace Orkige
{
	//! the classic web colour vocabulary of the fastgui widgets
	namespace Colours
	{
		enum Colour
		{
	...
	public:
		...
		//! @remarks the headless door - unit tests (FastGuiAtlasTests)
